        ...
        <main className="bg-black h-screen flex flex-col items-center justify-start">
            <div className="pt-20 max-w-lg flex flex-col justify-start items-start">
                <div className="flex flex-col">
                    <div className="text-gray-300 font-montserrat text-4xl">Log In</div>
                    ...
                    <div className="text-neutral-500  font-bold text-center pt-4 text-xs">Don't have an account? <span className="text-neutral-200">Sign Up</span></div>
                </div>
            </div>
        </main>
    )
