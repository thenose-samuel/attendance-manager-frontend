        ...
        <main className="bg-black h-screen flex flex-col items-center justify-start">
            <div className="pt-20 max-w-lg flex flex-col justify-start items-start">
                <div className="flex flex-col">
                    ...
                    <input placeholder="Enter your username" className="placeholder:text-neutral-600 max-w-full bg-neutral-900 rounded-md w-72 h-12 border-2 border-neutral-800 focus:ring-yellow-400 focus:ring-2 focus:outline-none text-gray-300 font-bold text-sm p-2"></input>
                    <div className="text-neutral-400 text-xs font-medium pb-2 pt-5">Password</div>
                    <input placeholder="Enter your password" className="placeholder:text-neutral-600 max-w-full bg-neutral-900 rounded-md w-72 h-12 border-2 border-neutral-800 focus:ring-yellow-400 focus:ring-2 focus:outline-none text-gray-300 font-bold text-sm p-2"></input>
