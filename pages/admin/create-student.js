import style from './create-student.module.css';
    ...
    return <>
        <div className={style.font}>
             <div className='h-screen bg-neutral-900 w-96 pl-6 pr-6 pt-4 border-neutral-800 border-solid border-x-2'>
                <div>
                    <div className='font-extrabold text-2xl text-neutral-200'>Create Student</div>
                    <div className='text-xs text-neutral-500 font-regular'>Enter student details</div>
                    <div className='pt-6'>
                    <div className="flex flex-col">
                    <div className="text-neutral-400 text-xs font-medium pb-2 placeholder:text-neutral-300" placeholder="Enter your username">Student Name</div>
                    <input placeholder="Enter your username" className="placeholder:text-neutral-600 max-w-full bg-neutral-900 rounded-md w-full h-10 border-2 border-neutral-800 focus:ring-yellow-400 focus:ring-2 focus:outline-none text-gray-300 font-regular text-sm p-2"></input>
                    <div className="text-neutral-400 text-xs font-medium pb-2 pt-5">Student ID</div>
