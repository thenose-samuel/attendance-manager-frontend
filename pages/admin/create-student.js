            ...
            <div className="pt-6">
              <div className="flex flex-col">
                ...
                <div
                  ...
                  } w-20 rounded-sm text-center font-bold mt-5 text-xs p-2 cursor-pointer hover:bg-pink-700 duration-200 text-white`}
                >
...
async function createUser(
  ...
  try {
    ...
    const response = await fetch(BASE_URL + CREATE_STUDENT, {
      method: "POST",
      headers: {
